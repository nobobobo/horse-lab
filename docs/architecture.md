...
- `payouts.csv`: 初期版は latest win odds と result から作る settlement proxy。将来は official payout record に置換する。
...
- payout/pool の settlement proxy または official payout mapper がある。
